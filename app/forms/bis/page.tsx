...
export default function BISForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("BIS Form Data:", formData)
          ...
          <Card>
            <CardHeader className="bg-orange-600 text-white">
              <CardTitle className="text-2xl flex items-center">
                ...
                BIS Form - Bureau of Indian Standards
              </CardTitle>
              <p className="text-orange-100 text-sm">भारतीय मानक ब्यूरो / Bureau of Indian Standards</p>
              <p className="text-orange-100 text-sm">
                3rd floor, Navajivan Amrut Jayanti Bhavan, Off. Ashram Road, Ahmedabad-380014
              </p>
            </CardHeader>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg">
                    <p className="text-sm text-orange-800 mb-2">
                      <strong>Service Code:</strong> T-CAB (Testing Services)
                    </p>
                    <p className="text-sm text-orange-800">
                      <strong>Head of Service:</strong> Submersible Pump Set Testing
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-700 mb-3">Available BIS Items (Drag to select)</h4>
                    <div className="grid md:grid-cols-2 gap-2">
                      {[
                        ...
                        "0.5 HP Submersible Motor",
                        "1 HP Submersible Motor",
                        "2 HP Submersible Motor",
                        "5 HP Submersible Motor",
                        ...
                        <div
                          ...
                          className="bg-white p-2 rounded border cursor-move hover:bg-orange-50 hover:border-orange-300 transition-colors text-sm"
                        >
                          📋 {item}
                        </div>
                      ))}
                  ...
                  {/* Drop Zone */}
                  <div
                    className="border-2 border-dashed border-gray-300 rounded-lg p-6 min-h-[200px] bg-orange-50"
