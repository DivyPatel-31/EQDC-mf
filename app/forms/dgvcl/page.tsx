...
export default function DGVCLForm() {
  const [formData, setFormData] = useState({
    ...
    gstAmount: "",
    totalAmount: "",
    items: [{ srNo: 1, nomenclature: "", qty: "1", serviceCharge: "" }],
  })

  const addItem = () => {
    setFormData((prev) => ({
      ...prev,
      items: [...prev.items, { srNo: prev.items.length + 1, nomenclature: "", qty: "1", serviceCharge: "" }],
    }))
  }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("DGVCL Form Data:", formData)
          ...
          <Card>
            <CardHeader className="bg-green-600 text-white">
              <CardTitle className="text-2xl flex items-center">
                ...
                DGVCL Form - Dakshin Gujarat Vij Co. Ltd.
              </CardTitle>
              <p className="text-green-100 text-sm">
                Corporate Office "UrjaSanan", Kapodara Char Rasta, Nana Varacha Road, Surat-395006
              </p>
            </CardHeader>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold text-gray-700 mb-3">Available DGVCL Items (Drag to select)</h4>
                    <div className="grid md:grid-cols-2 gap-2">
                      {[
                        ...
                        <div
                          ...
                          className="bg-white p-2 rounded border cursor-move hover:bg-green-50 hover:border-green-300 transition-colors text-sm"
                        >
                          📋 {item}
                        </div>
                      ))}
                  ...
                  {/* Drop Zone */}
                  <div
                    className="border-2 border-dashed border-gray-300 rounded-lg p-6 min-h-[200px] bg-green-50"
